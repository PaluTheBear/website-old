    ...
    return (
        <div className="main-wrapper">
            ...
            <TextTile>
                {() => <>
                    <h2>Vita</h2>
                    <p>From 2020-2022 I worked as Software Engineering Intern at <a href="https://www.iteratec.com">Iteratec</a>, enhancing clients by creating modern digital solutions using Java, TypeScript, React, Python and various other technologies and frameworks. </p>
                    <p>Teaching 'Theoretische Informatik' for two terms as a tutor.</p>
